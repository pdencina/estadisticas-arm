...
export default async function Page() {
  ...
  const enc = await getEncuentros(cId);
  ...
  return (
    <div className="page space-y-5">
      <div className="flex items-center justify-between">
        <div><h2 className="text-xl font-bold">Encuentros</h2><p className="text-xs text-gray-400 mt-0.5">Historial de encuentros reportados</p></div>
      ...
      <div className="card overflow-hidden">
        {enc.length===0?(<div className="py-12 text-center text-sm text-gray-400">Sin encuentros</div>):(

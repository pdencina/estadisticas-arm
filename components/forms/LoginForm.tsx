  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        <input name="email" type="email" required autoComplete="email" placeholder="nombre@armglobal.com" className="input" />
      </div>
      <div>
        <label className="label">Contraseña</label>
        <div className="relative">
          <input name="password" type={showPwd ? "text" : "password"} required autoComplete="current-password" placeholder="••••••••" className="input pr-10" />
